...
<footer class="site-footer contacts-footer indent-bottom-small" id="contact-form">
  <div class="container">
		<?php
    ...
    <div class="row">
        ...
        <div class="image-wrapper col-md-6" data-aos="fade-up" data-aos-duration="300">
          <div class="inner">
            <img
                class="object-fit"
                src="<?php echo wp_get_attachment_image_src($args['image'], 'full')[0];?>"
		          <?php
			          $altText = get_post_meta($args['image'], '_wp_attachment_image_alt', TRUE);
			          if ( !empty( $altText ) ):?>
    ...
    <div class="row">
        ...
        <div class="map-wrapper col-12" data-aos="fade-up" data-aos-duration="300">
          <div class="inner">
